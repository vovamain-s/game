...
function addItems() {
  ...
  createItem(180, 300, 'coin');
  createItem(435, 250, 'coin');
  createItem(630, 200, 'coin');
  createItem(300, 100, 'coin');
  createItem(375, 100, 'poison');
  createItem(170, 70,'poison');
...
window.onload = function () {
  ...
  function preload() {
    game.stage.backgroundColor = '#6c006c';
